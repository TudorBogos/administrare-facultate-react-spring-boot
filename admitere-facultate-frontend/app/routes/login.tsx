...
export default function Login() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      <div
        aria-hidden
        className="pointer-events-none absolute -top-40 right-[-10%] h-96 w-96 rounded-full bg-[#f6caa4] opacity-50 blur-[120px]"
      />
      <div
        aria-hidden
        className="pointer-events-none absolute bottom-[-20%] left-[-10%] h-[420px] w-[420px] rounded-full bg-[#f1a07a] opacity-40 blur-[140px]"
      />
      <div className="relative z-10 mx-auto flex min-h-screen max-w-5xl items-center px-6 py-16">
        <div className="grid w-full gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div className="space-y-6">
            <span className="pill">Administrare</span>
          ...
          <Card className="p-8">
            ...
            <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
              ...
              <FormField label="Parola" htmlFor="parola">
                <input
                  id="parola"
                  className="input"
                  type="password"
